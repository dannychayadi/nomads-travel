                        ...
                        @if($item->galleries->count())
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img src="{{ asset('uploads/'.$item->galleries->first()->image) }}" class="xzoom" id="xzoom-default"
                                        xoriginal="{{ asset('uploads/'.$item->galleries->first()->image) }}">
                                </div>
                                <div class="xzoom-thumbs">
                                    @foreach ($item->galleries as $gallery)
                                        <a href="{{ asset('uploads/'.$gallery->image) }}">
                                            <img src="{{ asset('uploads/'.$gallery->image) }}" class="xzoom-gallery" width="128"
                                                xpreview="{{ asset('uploads/'.$gallery->image) }}">
                                        </a>
                                    @endforeach
                                </div>
                            </div>
